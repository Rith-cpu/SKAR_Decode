...
@Autonomous(name = "AutoBlueFar9",group = "Blue")
public class AutoBlueFar9 extends LinearOpMode {
    ...
    private void shoot(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        ...
        Double distance = ld.getDistanceIfValid();
        tshi.AutoTurret(275);
        tshi.AutoShooter("start", 1480.14642); // if 14 put 59
    ...
    private void intakeBalls2(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        ...
        Actions.runBlocking(
                drive.actionBuilder(pos2)
                        .strafeToLinearHeading(new Vector2d(-64, -23), Math.toRadians(180),  new TranslationalVelConstraint(50))
                        .build());
    ...
    private void shootAgain(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        ...
        tshi.AutoLS(0.5);
        tshi.AutoTurret(425);
        tshi.AutoShooter("start", 1250.64553); // if 14 put 59
        ...
        Actions.runBlocking(
                drive.actionBuilder(pos2)
                        .strafeToLinearHeading(new Vector2d(-35,-5 ), Math.toRadians(180), new TranslationalVelConstraint(70), new ProfileAccelConstraint(-20, 90))
                        .build());
