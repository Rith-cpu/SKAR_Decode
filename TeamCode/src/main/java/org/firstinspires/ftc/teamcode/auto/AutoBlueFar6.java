...
@Autonomous(name = "AutoBlueFar6",group = "Blue")
public class AutoBlueFar6 extends LinearOpMode {
    ...
    private void shootandExit(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        Pose2d pos = new Pose2d(-65, -45, Math.toRadians(180));
        ...
        Pose2d pos2 = new Pose2d(-14, -57, Math.toRadians(180));

        Actions.runBlocking(
                drive.actionBuilder(pos2)
                        .strafeToLinearHeading(new Vector2d(-25, -57), Math.toRadians(180))
                        .build());
