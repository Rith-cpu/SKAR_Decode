...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2296.640767263115; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3452.9310119611514; // x position of the perpendicular encoder (in tick units)
    }
