...
@Autonomous(name = "AutoRedFar9",group = "Red")
public class AutoRedFar9 extends LinearOpMode {
    ...
    private void intakeBalls(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        ...
        Actions.runBlocking(
                drive.actionBuilder(pos2)
                        .strafeTo(new Vector2d(59, -41), new TranslationalVelConstraint(20), new ProfileAccelConstraint(-90, 90))
                        .build());
    ...
    private void shoot(MecanumDrive drive, TSHI tshi, TurretTesting tt, LimelightDistance ld) {
        Pose2d pos = new Pose2d(59, -41, Math.toRadians(10));
