...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOP - Blue - Double")
public class TeleOPBlueDouble extends LinearOpMode {

    public final PinpointLocalizer pinpointLocalizer;

    public TeleOPBlueDouble(PinpointLocalizer pinpointLocalizer) {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Bot Position", pinpointLocalizer.getPose());
