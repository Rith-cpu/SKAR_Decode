...
public class TurretTesting {
    ...
    private double kP = 0.05;         // proportional gain (deg -> power)
    ...
    private int maxTurretTicks = 675;
    private int minTurretTicks = -495;
    ...
    public void runLL() {
        ...
        // P control + feedforward (apply direction flip)
        double power = turretSign * (kPScaled * filteredTx + ffPower);
